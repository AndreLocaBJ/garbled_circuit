...
Questo particolare espediente viene chiamato permute-and-point e viene usato per la prima volta [@fval] successivamente spiegato più nel dettaglio nella tesi di Phillip Rogoway[@prog].Il permute-and-point permette di decidere quale voce della GTT deve essere decrittata dati gli input confusi, permettendo di eseguire calcoli più veloci e impedendo comunque al valutatore di dedurre qualcosa dall'ordine delle voci della tabella di verità.
