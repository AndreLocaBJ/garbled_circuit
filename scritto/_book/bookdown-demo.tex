...
\NormalTok{          bob_var_bool }\OperatorTok{=} \BuiltInTok{int}\NormalTok{(}\BuiltInTok{len}\NormalTok{(circ_bool[}\StringTok{'input'}\NormalTok{) }\OperatorTok{/} \DecValTok{2}\NormalTok{)}
      \BuiltInTok{file}\NormalTok{.write(}\StringTok{'}\SpecialCharTok{\{\}}\StringTok{;}\SpecialCharTok{\{\}}\StringTok{;}\SpecialCharTok{\{\}}\StringTok{;}\SpecialCharTok{\{\}}\StringTok{;}\SpecialCharTok{\{\}}\StringTok{;}\SpecialCharTok{\{\}}\StringTok{;}\SpecialCharTok{\{\}}\StringTok{;}\SpecialCharTok{\{\}}\CharTok{\textbackslash{}n}\StringTok{'}\NormalTok{.forma(blfmv.split(}\StringTok{'.'}\NormalTok{)[}
          \DecValTok{0}\NormalTok{], costo_bool, alice_var_bool,bob_var_bool, circ_mv[}\StringTok{'dominio'}\NormalTok{],costo_mv, alice_var_mv, bob_var_mv))}
\end{Highlighting}
\end{Shaded}
